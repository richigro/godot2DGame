...
@onready var purcahse_button = $%PurcahseButton
...
func _ready():
	purcahse_button.pressed.connect(on_purchase_pressed)
...
func update_progress():
	...
	purcahse_button.disabled = percent < 1 || is_maxed
	if is_maxed:
		purcahse_button.text = "Maxed"
...
func on_purchase_pressed():
	...
	# upgrade the progress on all card after expending currency
